...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { price: @variation.price, sku: @variation.sku, stock: @variation.stock } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { price: @variation.price, sku: @variation.sku, stock: @variation.stock } }
